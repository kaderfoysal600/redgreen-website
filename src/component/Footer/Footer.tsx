    ...
    <footer className="mt-12 flex flex-col gap-2 items-center justify-center bg-white p-20 border-t-2 border-[#6e6e73]">
      ...
      <div className="my-4 icon-container flex items-center gap-4">
        <a href="" className="group/item">
          <svg
            className="group-hover/item:fill-[#1B74E4]"
        ...
        <a href="" className="group/item2">
          <svg
            className="group-hover/item2:fill-[#1D9BF0]"
            xmlns="http://www.w3.org/2000/svg"
            height="1.5em"
            viewBox="0 0 512 512"
          >
        ...
        <a href="" className="group/item3">
          <svg
            className="group-hover/item3:fill-[#c13584]"
            xmlns="http://www.w3.org/2000/svg"
            height="1.5em"
            viewBox="0 0 448 512"
          >
        ...
        <a href="" className="group/item4">
          <svg
            className="group-hover/item4:fill-[#f00]"
            xmlns="http://www.w3.org/2000/svg"
            height="1.5em"
            viewBox="0 0 576 512"
          >
      ...
      <div className="link-1 flex items-center gap-4 text-base">
        <a href="">HOME</a>
        <a href="">ABOUT US</a>
        <a href="">PRIVACY</a>
